...
import { SAAS_CHAT_UTM_URL, YUQUE_URL } from "@/app/constant";
...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : `😆 对话遇到了一些问题，不用慌:
       \ 1️⃣ 无权限人员请使用自己的 OpenAI 密钥，点击[这里](/#/settings)修改设置 ⚙️
       \ 2️⃣ 如果你正在使用私有部署版本,[获取密钥](${YUQUE_URL})，点击[这里](/#/auth)输入访问秘钥 🔑
       `,
  },
  Auth: {
    Return: "返回",
    ...
    TopTips:
      "🥳 SeaMaidChat AI 首发优惠，立刻解锁 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "使用 SeaMaidChat AI",
        Label: "（性价比最高的方案）",
        SubTitle:
          "由 SeaMaidChat 官方维护, 零配置开箱即用，支持 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
        ChatNow: "立刻对话",
      },
      AccessCode: {
        Title: "访问密码",
