...
const en: LocaleType = {
  ...
  Auth: {
    ...
    TopTips:
      "🥳 SeaMaidChat AI launch promotion: Instantly unlock the latest models like OpenAI o1, GPT-4o, Claude-3.5!",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        SubTitle:
          "Maintained by SeaMaidChat, zero setup needed, unlock OpenAI o1, GPT-4o," +
          " Claude-3.5 and more",
        ChatNow: "Start Now",
      },
      AccessCode: {
